...
from .krx import (
    get_kr_balance_sheet,
    get_kr_cashflow,
    get_kr_fundamentals,
    get_kr_income_statement,
    get_kr_indicators,
    get_kr_news,
    get_kr_stock_data,
)
...
VENDOR_METHODS = {
    # core_stock_apis
    "get_stock_data": {
        "krx": get_kr_stock_data,
        "alpha_vantage": get_alpha_vantage_stock,
        "yfinance": get_YFin_data_online,
    },
    # technical_indicators
    "get_indicators": {
        "krx": get_kr_indicators,
        "alpha_vantage": get_alpha_vantage_indicator,
        "yfinance": get_stock_stats_indicators_window,
    },
    # fundamental_data
    "get_fundamentals": {
        "krx": get_kr_fundamentals,
        "alpha_vantage": get_alpha_vantage_fundamentals,
        "yfinance": get_yfinance_fundamentals,
    },
    "get_balance_sheet": {
        "krx": get_kr_balance_sheet,
